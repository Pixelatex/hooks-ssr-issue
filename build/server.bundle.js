...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e51a09c10323760c54e1";
...
var app = __webpack_require__(/*! ./server */ "./src/server.js");
...
if (true) {
  console.log("\u2705  Server-side HMR Enabled! ".concat(port));
  module.hot.accept(/*! ./server.js */ "./src/server.js", function () {
    console.log("🔁  HMR Reloading `./server`...");

    try {
      app = __webpack_require__(/*! ./server.js */ "./src/server.js");
...
serverInstance.get("/", function (req, res) {
  console.log(app, "app");
  var code = React.createElement(app["default"] || app);
  var result = renderToString(code);
  res.send(result);
});
module.exports = serverInstance; // const server = http.createServer(serverInstance);
